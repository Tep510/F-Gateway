  ...
  try {
    ...
    const clients = await prisma.client.findMany({
      ...
      select: {
        ...
        clientName: true,
        status: true,
        shippingPlanDriveId: true,
        shippingResultDriveId: true,
        receivingPlanDriveId: true,
        receivingResultDriveId: true,
        asanaEnabled: true,
  ...
  try {
    ...
    const client = await prisma.client.create({
      data: {
        ...
        clientName,
        status: 'active',
        shippingPlanDriveId: shippingPlanDriveId || null,
        shippingResultDriveId: shippingResultDriveId || null,
        receivingPlanDriveId: receivingPlanDriveId || null,
        receivingResultDriveId: receivingResultDriveId || null,
        asanaProjectId,
